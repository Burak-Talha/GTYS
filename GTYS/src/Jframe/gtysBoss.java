...
public class gtysBoss extends JFrame {
	...
	public gtysBoss() {
		...
		btnNewButton_1.addMouseListener(new MouseAdapter() {
			...
			public void mousePressed(MouseEvent e) {
				gtysBoss_register frame2 = new gtysBoss_register();
		...
		btnNewButton_2.setBounds(392, 278, 117, 29);
