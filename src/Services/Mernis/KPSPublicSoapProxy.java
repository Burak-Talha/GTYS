...
public class KPSPublicSoapProxy implements Services.Mernis.KPSPublicSoap {
  private String _endpoint = null;
  private Services.Mernis.KPSPublicSoap kPSPublicSoap = null;
  ...
  private void _initKPSPublicSoapProxy() {
    try {
      kPSPublicSoap = (new Services.Mernis.KPSPublicLocator()).getKPSPublicSoap();
  ...
  public Services.Mernis.KPSPublicSoap getKPSPublicSoap() {
    if (kPSPublicSoap == null)
      _initKPSPublicSoapProxy();
