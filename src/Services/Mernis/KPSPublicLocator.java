...
public class KPSPublicLocator extends org.apache.axis.client.Service implements Services.Mernis.KPSPublic {
    ...
    public Services.Mernis.KPSPublicSoap getKPSPublicSoap() throws javax.xml.rpc.ServiceException {
    ...
    public Services.Mernis.KPSPublicSoap getKPSPublicSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            Services.Mernis.KPSPublicSoapStub _stub = new Services.Mernis.KPSPublicSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (Services.Mernis.KPSPublicSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                Services.Mernis.KPSPublicSoapStub _stub = new Services.Mernis.KPSPublicSoapStub(new java.net.URL(KPSPublicSoap_address), this);
                _stub.setPortName(getKPSPublicSoapWSDDServiceName());
                return _stub;
            }
        }
